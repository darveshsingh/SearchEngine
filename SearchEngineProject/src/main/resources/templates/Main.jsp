	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#searchPage">Advanced Computing Concepts - Search Engine 2019</a>
			</div>
		</div>
	</nav>
	...
	<div id="contact" class="container">
		...
		<div class="row">
			<div class="col-lg-offset-2">
				<form class= "searchForm" action="#" th:action="@{/search}" th:object="${searchQuery}"
					method="post">
